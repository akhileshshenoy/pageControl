...
class EventCell: UITableViewCell {
    ...
    @objc let titleLabel: UILabel = {
        ...
        if model == "iPhone 5s" || model == "iPhone SE" || model == "iPhone 5" || model == "iPhone 5c" || model == "Simulator"{
    ...
    private func setupTitle() {
        ...
        _ = locationLabel.anchor(nil, left: nil, bottom: backgroundCard.bottomAnchor, right: backgroundCard.rightAnchor, topConstant: 0, leftConstant: 16, bottomConstant: 8, rightConstant: 8, widthConstant: 0, heightConstant: 0)
    }
